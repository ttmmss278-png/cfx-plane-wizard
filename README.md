...
大多数模块的输入文件均在浏览器或本机处理，不会上传到云端。第 06 个“CFX-Post 公式与命令库”可按用户配置通过 GitHub API 与私有数据仓库同步公式、CCL、分类和文件夹数据；第 07 个“网格无关性验证”当前仅在浏览器本地处理输入与计算。
