...
const modules: ToolModule[] = [
  ...
  },
  {
    ...
    runtime: "browser",
    runtimeLabel: "纯浏览器",
    entry: "modules/plane-wizard/index.html?v=1.1.0",
    help: "modules/plane-wizard/使用说明.html?v=1.1.0",
  ...
  },
  {
    ...
    runtime: "browser",
    runtimeLabel: "纯浏览器",
    entry: "modules/jet-quality-evaluator/index.html?v=2.3.0",
    help: "modules/jet-quality-evaluator/使用说明.html?v=1.1.0",
    icon: Activity,
    tone: "cyan",
  ...
  },
  {
    ...
    runtime: "browser",
    runtimeLabel: "纯浏览器",
    entry: "modules/roundness-deviation/index.html?v=1.2.0",
    help: "modules/roundness-deviation/使用说明.html?v=1.2.0",
    icon: CircleDotDashed,
    tone: "orange",
