...
const modules: ToolModule[] = [
  ...
  },
  {
    ...
    title: "指标处理与综合评价",
    shortTitle: "指标与评价",
    description: "偏离圆度、射流偏移度、速度均匀性联动评价；也可直接导入其他数据，自定义指标与权重。",
    category: "数值验证",
    runtime: "browser",
    runtimeLabel: "纯浏览器",
    entry: "modules/quality-workbench/index.html?v=1.7.0",
    help: "modules/quality-workbench/使用说明.html?v=1.1.0",
    icon: Activity,
    tone: "cyan",
